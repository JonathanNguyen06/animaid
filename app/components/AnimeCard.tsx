...
export default function AnimeCard({ anime }: { anime: Anime }) {
    ...
    return (
        <Link
            ...
            className="group block rounded-xl border border-purple-200/70 bg-white shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden hover:-translate-y-0.5 cursor-pointer"
        >
